      ...
      <div className="w-full h-full px-4 lg:px-16 py-8 mx-auto">
        <div className="w-full h-full lg:flex lg:justify-center lg:items-center">
          <div className="w-full max-w-sm flex justify-center">
            <Image
              className="w-3/6 h-52 rounded-lg lg:h-[15rem]"
              src={pusblogo}
              alt=""
              width={500}
              height={500}
          ...
          <div className="w-full lg:flex lg:flex-col lg:justify-center mt-8 px-4 lg:mt-0 py-4">
            ...
            <div className="mt-4 text-justify">
              <p>
                <span className="font-bold text-lg"> “Sanctus”</span> is
                conception of sanctuary that portrays a haven of peace, safety,
                and continuous growth. Reflects a commitment to creating a
